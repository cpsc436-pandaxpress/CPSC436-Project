...
void BossScene::generate_platforms(Blackboard &blackboard) {
    auto shader = blackboard.shader_manager.get_shader("sprite");
    float max_x =
...
void BossScene::generate_floating_platforms(Blackboard &blackboard) {
    auto shader = blackboard.shader_manager.get_shader("sprite");
    float max_x =
            blackboard.camera.position().x + blackboard.camera.size().x; // some distance off camera
...
void BossScene::create_bread(Blackboard &blackboard) {
...
void BossScene::generate_obstacles(Blackboard &blackboard) {
    float max_x =
